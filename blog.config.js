...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'RE', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '写作，分享，互助', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.rainstormdesign.top', // 网站地址
